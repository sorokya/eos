...
// `vector<Wedding *,allocator<Wedding *> >`. sizeof is 0x2c:
//   +0x00 char *                  encode_scratch = new char[8] (base-253 buffer)
//   +0x04 Players *               players
//   +0x08 Packets *                server
//   +0x0c vector<Wedding *>  active_weddings (sizeof 0x20)
class WeddingController
{
  public:
    ...
    Players *players;
    Packets *server;
    vector<Wedding *> active_weddings;

    WeddingController(Players *players, Packets *server);
    ~WeddingController();
