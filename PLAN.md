...
| Mysqlcontrols partial (19/28 hand-written) | 2 | in-progress | Byte-exact: `Free`, `FUN_004752d4`, `FUN_00475b20`, `Db_GetString`, `Db_GetInt`, `FUN_00476bfc`, `FUN_00476c14`, `GetResultCount`, `Mysql_SubmitQuery`, `Mysql_SubmitQuery_FromCallback`, `Query`, `Mysql_ExecDirect`, `Mysql_ExecDirect_FromCallback`, `ExecDrop`, `Db_GetActiveConnectionCount`, `FUN_004772a0`, `FUN_004772b8`, `SpamGuard_CheckCooldown`, `Server_GetUptime`. Remaining: ctor (the `Mysqlthread::Spawn` package-VMT first arg), `TestConnection`/`Connect`/`FUN_004762c8` (`try`/`catch` and string-build structure), `Database_CanReconnect` (1 insn), `Mysql_SanitizeString` (branch layout), `Db_SanitizeString` (1 insn), `Chat_HasBadWords` (one deref), `FUN_00477a00` (decoder). The ~45 `std::vector`/allocator COMDATs are emitted from the member declarations |
