...
**1602/1809 (88.6%)** application functions byte-exact (1809 app + compiler COMDATs; 502 library members excluded).
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Mapcontrol | 279 | 249 | 25 | 1 | 4 |
| Packets | 249 | 83 | 150 | 10 | 5 |
