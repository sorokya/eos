...
**1540/1809 (85.1%)** application functions byte-exact (1809 app + compiler COMDATs; 502 library members excluded).
...
| --- | ---: | ---: | ---: | ---: | ---: |
| Mapcontrol | 279 | 228 | 47 | 0 | 4 |
| Packets | 249 | 72 | 168 | 4 | 4 |
| Players | 160 | 153 | 7 | 0 | 0 |
